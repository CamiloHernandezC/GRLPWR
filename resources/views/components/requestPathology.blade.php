...
<div class="input-group" id= "globalPathology" style="margin-top: -12px">
    ...
    <div class="d-inline-block">
        ...
        <div class="custom-control custom-radio custom-control-inline" id="containerPathology1">
            ...
            <label class="custom-control-label" id="labelPathology1" for="pathology1">Si</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline" id="containerPathology2">
...
<div id="pathology-description" class="input-group mt-2" style="margin-left: 45px; {{Auth::user()?->cliente != null && Auth::user()->cliente->pathology != null ? '' : 'display:none'}}">
    <div class="form-group label-floating">
        ...
        <input name="pathology" id="pathology" class="form-control" required value="{{Auth::user()?->cliente != null ? Auth::user()->cliente->pathology : ''}}">
    </div>
</div>
